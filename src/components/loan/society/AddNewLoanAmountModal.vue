    ...
    <div class="modal-dialog modal-lg">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title">Add new loan amount for {{ societyName }}</h4>
...
export default {
  ...
  methods: {
    ...mapActions("app/society_loan", ["getLoanAmountGivenHistoryForAdmin", "giveMoreLoanToSociety"]),
    ...
    addNewLoanAmountEventHandler(){
      ...
      if (validation.fails()){
        ...
        this.giveMoreLoanToSociety({formData:{amount_given:this.$data.amount_given}, loanRequestID:this.$props.loan_request_id})
        .then(data => {
          if (data){
